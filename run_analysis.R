...
##Extraer las medidas de la desviación estándar y media de cada medida.
TidyData <- Merged_Data %>% select(subject, code, contains("mean"), contains("std"))

##Nombrar actividades descriptivas para el conjunto de datos.
...
##A partir del conjunto de datos del paso anterior,crear un segundo conjunto de datos ordenado e independiente 
